...
- Tracked machine support samples both crawler footprints. The September 2026 revision uses pressure, bearing area and finite compression history; excavated depth no longer creates additional chassis sinkage. See [soil physics implementation and validation](soil-physics.md) for equations, calibration and flowing discharge.
